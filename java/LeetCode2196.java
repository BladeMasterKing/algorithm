...
public class LeetCode2196 {
    public TreeNode createBinaryTree(int[][] descriptions) {
        ...
        rootVal = recursion(rootVal, descriptions);
    ...
    public int recursion(int root, int[][] descriptions){
        for (int i=1;i<descriptions.length;i++){
            int[] currentArray = descriptions[i];
            if (currentArray[1] == root){
                return recursion(currentArray[0], descriptions);
            }
        }
        return root;
    }
    ...
    public static void main(String[] args) {
        ...
        LeetCode2196 o = new LeetCode2196();
        TreeNode binaryTree = o.createBinaryTree(descriptions);
